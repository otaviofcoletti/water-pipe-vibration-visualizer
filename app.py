...
The dataset contains two types of visualization:

- **Magnitude of Accelerometer data (Left):**  

- **Power generated by accelerometer (Right):**  
  Contain corresponding power measurements for the same flow condition. 
